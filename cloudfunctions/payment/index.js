...
exports.main = async (event, context) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let {
        OPENID="wx5085c0ec03e0db18",
        APPID = cloud.getWXContext().OPENID,
      } = cloud.getWXContext()
      // 附加数据 例如:深圳分店
      const attach = "sssy"
      ...
      if (xml.indexOf('prepay_id') < 0) throw { code: 7350, data: formData, info: '支付失败！' }
